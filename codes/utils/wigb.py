...
def wigb(a=None, scale=1, x=None, z=None, a_max=None, figsize=(30, 15), no_plot=False, direction='Vertical',linewidth = 2):
    """
    ...
    if direction == 'Vertical':
        ...
        for index_x in range(n_trace):
            trace = a[:, index_x]
            plt.plot(index_x * dx + trace, z, 'k-', linewidth=linewidth)
        ...
        for index_z in range(n_trace):
            trace = a[:, index_z]
            plt.plot(z, index_z * dx + trace, 'k-', linewidth=linewidth)
