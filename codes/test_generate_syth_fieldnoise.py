...
def generate_test(model, opt):
    ...
    hdf_path1='/home/shendi_mcj/datasets/seismic/hdf5/marmousi35_tst_XJ_s110_120_noise_Patches_256.hdf5'
    hdf_path2 ='/home/shendi_mcj/datasets/seismic/hdf5/marmousi35_trn_XJ_s80_110_noise_Patches_256_orthofxdecon.hdf5'
    ...
    original=im_pair_list[20][:,:,0]
    x_max = max(abs(original.max()), abs(original.min()))
    label=im_pair_list[20][:,:,1]
    ...
    # generated clean
    ssim_Dn_GT, ssim_map_Dn_GT = compare_ssim(x, denoised,full=True)
    psnr_Dn_GT = compare_psnr(groundtruth, denoised)
...
def main():
    ...
    #2023.3.10  InvDN_ResUnit_x4_mrms35_XJns80_110
    opt['path']['pretrain_model_G'] = '../experiments/mrms35_gn005/InvDN_ResUnit_x4_mrms35_gn005/models/1_G.pth'
